                    ...
                    if (message.author.id === Owner || Trusted) {
                        ...
                        */
                        function Whitelist(ID) {
                            ...
                            if (InArray === true) {
                                ...
                                const Successful = new Discord.MessageEmbed()
                                    .setDescription(`<a:solar_correct:839832535302275112> Successfully whitelisted \`${GetMember.id}\`. Updating Database!`)
                                    .setColor(0x36393E)
                        ...
                        const Unauthorised = new Discord.MessageEmbed()
                            .setDescription(`<a:solar_incorrect:839832464083910707> You are not authorised to use this command.`)
                            .setColor(0x36393E)
                        message.channel.send(Unauthorised)
                    }
                } else {
                    const noID = new Discord.MessageEmbed()
                        .setDescription('<a:solar_incorrect:839832464083910707>: User not mentioned')
                        .setColor(0x36393E)
