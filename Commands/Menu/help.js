...
module.exports = {
    ...
    async run(client, message, args) {
        const help = new Discord.MessageEmbed()
            .setTitle(`<:OIP2:840706591786270760> ${client.user.username} <:OIP2:840706591786270760>`)
            .setDescription(`<a:bf_minimod:840711651275833384> Anti Nuke. <a:bf_minimod:840711651275833384> \n\n\`SET-UP\` \n\`OTHER\` \n\`INVITE\` \n\`ABOUT\` `)
