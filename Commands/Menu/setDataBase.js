...
module.exports = {
    ...
    async run(client, message, args) {
        ...
        const path2 = `Commands/Database/Backup Guilds/${guildID}.json`;
                ...
                if (err) {
                    ...
                    if (message.author.id === Owner) {
                        ...
                        const Unauthorised = new Discord.MessageEmbed()
                            .setDescription(`<a:solar_incorrect:839832464083910707> You are not authorised to use this command | Owner only!`)
                            .setColor(0x36393E)
                    ...
                    */
                    function BackUpRetrieve() {
                        ...
                        const currentPath = pather.join(__dirname, "../Database/Backup Guilds/", `${guildID}.json`);
            ...
            fs.access(path, fs.F_OK, (err) => {
                if (err) {
                            ...
                            fs.writeFile(`./Commands/Database/Guilds/${ID}.json`, content, 'utf8', function (err) {
                                if (err) {
                                    ...
                                    const Successful = new Discord.MessageEmbed()
                                        .setDescription(`<a:solar_correct:839832535302275112> Successfully created **${message.guild.name}** Database.`)
                                        .setColor(0x36393E)
                    ...
                    const err = new Discord.MessageEmbed()
                        .setDescription(`<a:solar_incorrect:839832464083910707> : Guild Already in Database.`)
                        .setColor(0x36393E)
